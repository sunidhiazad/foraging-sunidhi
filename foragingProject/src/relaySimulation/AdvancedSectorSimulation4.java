...
//Communicate to Hierarchical neighbors and one Quadrant neighbor
public class AdvancedSectorSimulation4 {
	...
	public AdvancedSectorSimulation4(Cell food) {
		this.gridSize = 128;
		this.numAgents = 8;
		this.food = food;
	...
	private boolean allAgentsAware() {
		for (Agent a : agents) {
	...
	private boolean hierNeighboursAware(Agent ag) {
	...
	public static void main(String[] args) {
		new AdvancedSectorSimulation4(new Cell(36,19));
	}
}
