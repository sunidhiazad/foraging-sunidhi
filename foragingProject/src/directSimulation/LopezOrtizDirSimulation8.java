...
public class LopezOrtizDirSimulation8 {
	...
	public LopezOrtizDirSimulation8(int gridSize, int numAgents, Cell food) {
	...
	public static void main(String[] args) {
		new LopezOrtizDirSimulation8(40, 8, new Cell(0,0));
	}
}
