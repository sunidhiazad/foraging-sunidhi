...
public class StripeDirSimulation {
	...
	public StripeDirSimulation(int gridSize, int numAgents, Cell food) {
		this.gridSize = gridSize;
		this.numAgents = numAgents;
		this.food = food;
		this.paths = new Stripes(gridSize, numAgents).getPaths();
		this.origin = Operations.getOrigin(gridSize);
		if (gridSize / numAgents % 2 == 1)
			this.expStartTime = gridSize - 1;
		else
			this.expStartTime = gridSize * (1 - 1 / numAgents);
	...
	public static void main(String[] args) {
		new StripeDirSimulation(128, 16, new Cell(60,60 ));
	}
}
